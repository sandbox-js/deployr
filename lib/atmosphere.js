        ...
        if (_request.logLevel === 'debug') {
            ...
            function _getWebSocket(location) {
                if (_request.webSocketImpl != null) {
                    console.log(_request.webSocketImpl);
                    return _request.webSocketImpl;
                } else {
                    console.log('new Websocket....');
                    return new WebSocket(location);
                    /*
                    if (window.WebSocket) { SW
            ...
            function _buildWebSocketUrl() {
                return _attachHeaders(_request, _request.url);
                //return _attachHeaders(_request, atmosphere.util.getAbsoluteURL(_request.url)).replace(/^http/, "ws"); SW
            }
            ...
            function _executeWebSocket(webSocketOpened) {
                ...
                _websocket.onmessage = function (message) {
                    ...
                    if (isString) {
                        ...
                        if (!skipCallbackInvocation) {
                            _invokeCallback();
                            console.log('Hereereerrererr......');
                            _response.responseBody = '';
                            _response.messages = [];
                        }
                    } else {
                        console.log('_handleProtocol.....')
            ...
            function _invokeCallback() {
                ...
                if (_localStorageService == null && _localSocketF != null) {
                    // _localSocketF(_response.responseBody); ////// SW
                }
